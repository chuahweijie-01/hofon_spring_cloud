...
exports.order_display_list = (company_id, page_info) => {
    ...
    return connectionPool.getConnection()
        ...
        .then(([rows, field]) => {
            ...
            return connection.query(`SELECT order_id, merchant_trade_number, order_total_item, order_final_price, order_status, DATE_FORMAT(trade_date, '%D %M %Y %H:%i:%s') AS trade_date
