    ...
    award_model.getProductList(req.session.company)
        ...
        .then((award) => {
            ...
            res.render('award_edit', {
                ...
                navigation: '<li><a href="/api/dashboard">管理總表</a></li><li><a href="/api/award">暢銷排行</a></li><li class="active">新增暢銷排行</li>',
    ...
    award_model.getAwardList(req.session.company, req.query)
        .then((result) => {
            res.render('award', {
                title: "暢銷排行",
                icon: '<span class="glyphicon glyphicon-certificate" aria-hidden="true"></span>',
                navigation: '<li><a href="/api/dashboard">管理總表</a></li><li class="active">暢銷排行</li>',
                message: req.flash(`flash`),
                data: result.rows,
